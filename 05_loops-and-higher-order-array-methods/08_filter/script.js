...
// Filter all the even numbers from the numbers array.
// Using filter method and a standard function as callback function
const evenNumbers = numbers.filter(function (number) {
  return number % 2 == 0;
});
console.log(evenNumbers, numbers);

// Using filter method and an arrow function as callback function

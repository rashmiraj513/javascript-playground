...
// When the name of the attribute is multi-word string like (first name)
// then using the following syntax, the value can be accessed.
...
// Get entries - Returns array of arrays

...
// Even though the strLit variable is a string literal for a primitive
// type, it can still use the toUpperCase() method because the string
// literal is converted to a String object behind the scenes.
...
// constructor. It returns false if it is a literal.
...
// Functions can be created using Function constructors.
